...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$MLtK3AMyqPlUoRZA527zL.hofHOOPpXJkd8KqM/ERwx2Mdw20zX5C';
...
-- COMMENT 테이블 PARANT_NO 컬럼 NULL 허용
ALTER TABLE "COMMENT"
...
BEGIN
	FOR I IN 1..2000 LOOP
		...
		VALUES(SEQ_BOARD_NO.NEXTVAL,
				...
				DEFAULT, DEFAULT, DEFAULT, DEFAULT, 8,
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '20221116105843_00003.gif', '3.gif', 0, 1994);
...
INSERT INTO BOARD_LIKE VALUES (2000, 8);
INSERT INTO BOARD_LIKE VALUES (1999, 8);
...
-- 오타난 컬럼명 수정
ALTER TABLE BOARD_IMG RENAME COLUMN IME_ORDER TO IMG_ORDER;
...
READ_COUNT, TO_CHAR(B_UPDATE_DATE, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') B_UPDATE_DATE,-- 2022년 11월 18일 10:33:21
...
SELECT * FROM MEMBER;
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 2000, 9, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 2000, 10, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 2000, 8, 2004);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 2000, 9, 2004);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 2000, 8, 2004);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 2000, 9, 2005);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 2000, 8, 2005);
COMMIT;
...
SELECT LEVEL, C.* FROM
	(SELECT COMMENT_NO, COMMENT_CONTENT,
		TO_CHAR(C_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') C_CREATE_DATE,
		BOARD_NO, MEMBER_NO, PROFILE_IMG,
		PARENT_NO, COMMENT_DEL_FL, MEMBER_NICKNAME
	FROM "COMMENT"
	JOIN MEMBER USING(MEMBER_NO)
	WHERE BOARD_NO=2000
